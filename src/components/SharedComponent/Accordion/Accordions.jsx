                                ...
                                >
                                    <Card.Body>
                                        <form className={styles.filterForm}>
                                            ...
                                            { (type === 'Drivers List' || type === "EV Road Assistance Booking List" || type === "EV Road Assistance Invoice List" || type === "EV Road Assistance Failed Booking List" || type === "Total Public Chargers List" || type === "EV Charger List" || type === "EV Chargers" || type === "EV Product List" ||  type === "EV Accessories" || type === "Charger Installation List" || type === "Charger Installation Booking" || type === "Driver Location" || type === "Driver Details" || type === "Coupon List" || type === "Offer Details" || type === "EV Charger Bookings" || type === "EV Accessories Bookings" || type === "Mobile EV Charging Failed Booking List" || type === "Mobile EV Charging Slot List" || type === "Mobile EV Charging Invoice List" || type === "Mobile EV Charging Booking List" || type === "EV Products & Installation" ) && (
                                                <div className={`col-xl-3 col-lg-6 col-12 ${styles.filterItem}`}>
