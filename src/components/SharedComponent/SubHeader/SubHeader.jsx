...
const SubHeader = ({ heading, fetchFilteredData, dynamicFilters, filterValues, addButtonProps, searchTerm, count, modalTitle, setRefresh, apiEndPoint, nameKey, setDownloadClicked, handleDownloadClick, scheduleDateChange, scheduleFilters, areaOptions, areaSelected, handleArea, rowOptions, rowSelected, handleRowperPagePage, onFilterChange, isLoading, hideSearch = false, hideFilter = false, }) => {
    ...
    const headingArray = ["Notification List", "List of all users", "EV Road Assistance Invoice List", "Drivers List", "Brands", "Home Charger Area List", "Home Charger Device List", "Home Charger Slot List", "Roadside Assistance Slot List", "EV Products & Installation", "Chargers Share Listings", "Home EV Charging Package List"]
