...
const SubHeader = ({ heading, fetchFilteredData, dynamicFilters, filterValues, addButtonProps, searchTerm, count, modalTitle, setRefresh, apiEndPoint, nameKey, setDownloadClicked, handleDownloadClick, scheduleDateChange, scheduleFilters, areaOptions, areaSelected, handleArea, rowOptions, rowSelected, handleRowperPagePage, onFilterChange, isLoading, hideSearch = false, hideFilter = false, }) => {
    ...
    const shouldShowFilterButtonArr = ["Total App Signup List", "Total Deleted Account List", "Failed Ride Booking List", "Notification List", "List of all users", "Brands", "EV Charger Booking List", "EV Chargers List", "EV Accessories List", "Offer List", "Mobile EV Charging List", "Incomplete Ride Booking List", "Support Request List", "Refund Request List", "Total Community List", "Charger List", "Resident List"]
    const shouldShowFilterButton = !shouldShowFilterButtonArr.includes(heading)

    const shouldShowSearchButtonArr = ["Total Deleted Account List", "Notification List", "List of all users", "EV Road Assistance Invoice List", "List of Universities", "List of Students", "Offer List", "Mobile EV Charging Slot List", "Total Community List", "Charger List", "Resident List"]
    const shouldShowSearchButton = !shouldShowSearchButtonArr.includes(heading)
    // "Ride Booking List", "Failed Ride Booking List", 

    const shouldShowAddButtonArr = ["Total App Signup List", "Total Deleted Account List", "Ride Booking List", "Failed Ride Booking List", "Notification List", "EV Road Assistance Booking List", "EV Road Assistance Invoice List", "EV Road Assistance Failed Booking List", "Charger Installation Booking", "EV Charger Booking List", "EV Charger Bookings", "EV Accessories Bookings", "Mobile EV Charging Booking List", "Mobile EV Charging Invoice List", "Mobile EV Charging Failed Booking List", "Ev Insurance List", "Customer Charging Van Booking List", "Chargers Share Listings", "Incomplete Ride Booking List", "Invoice List", "Support Request List", "Refund Request List", "Charger List", "Resident List", "Total Session History", "Total Invoice History"];
