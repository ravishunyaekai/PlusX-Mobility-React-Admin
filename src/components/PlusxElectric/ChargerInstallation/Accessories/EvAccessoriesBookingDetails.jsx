...
const EvAccessoriesBookingDetail = () => {
    ...
    const sectionContent1 = {
        ...
        address       : (
            <a target= "_blank" rel= "noopener noreferrer" className= 'linkSection' href= {`https://www.google.com/maps?q=${bookingDetails?.latitude},${bookingDetails?.longitude}`}>
            ...
            { loading ? <Loader /> : 
                <>
                    ...
                    <div className={styles.ChargerDetailsSection}>
                        <BookingLeftDetails titles={sectionTitles1} content={sectionContent1} sectionTitles4={sectionTitles4} sectionContent4={sectionContent4} type='chargerInstallation' />
...
export default EvAccessoriesBookingDetail;
