...
const EvChargerList = () => {
    ...
    const fetchList = (page, appliedFilters = {}) => {
        ...
        postRequestWithToken('/ev-accessories-list', obj, async(response) => {
    ...
    const addButtonProps = {
        ...
        link    : "/electric/charger-installation/accessories-add"
    };
    
    return (
        <div className='main-container'>
            <SubHeader heading = "EV Accessories"
            ...
            {loading ? <Loader /> :
                chargerList.length === 0 ? (
                    <EmptyList
                        tableHeaders={["Product ID", "Product Name","Output Power", "Price","Status", "Action"]}
                ...
                <>
                    <List 
                        ...
                        keyMapping = {[
                            { key: 'charger_id',   label: 'Product ID' }, 
                            { key: 'charger_name', label: 'Product Name' }, 
