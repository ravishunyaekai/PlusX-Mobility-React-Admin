        ...
        if (validateForm(featureValues)) {
            ...
            postRequestWithTokenAndFile('ev-accessories-add', formData, async (response) => {
                if (response.status === 1) {
                    ...
                    console.log('Error in add-product API:', response);
                    setLoading(false);
                }
            } )
        } else {
            ...
            <div className={styles.addStationFormSection}>
                ...
                <form className={styles.formSection} onSubmit={handleSubmit}>
                    ...
                    <div className={`row`}>
                        ...
                        <div className={`col-lg-6`}>
                            <label htmlFor="usedFor" className={styles.labelText}>Charger Type</label>
                            <div className={`row`}>
                                <div className={`col-xl-10 col-lg-12`}>
                                    <CustomDropdown options={chargerTypeOption} value={chargerType} onChange={handleChargerType} labelledBy="Select Charger Type" closeOnChangedValue={false} closeOnSelect={false}/>
