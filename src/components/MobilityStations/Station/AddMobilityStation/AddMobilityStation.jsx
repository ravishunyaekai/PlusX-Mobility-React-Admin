...
const AddMobilityStation = () => {
        ...
        if (validateForm()) {
            ...
            if (galleryFiles.length > 0) {
                galleryFiles.forEach((galleryFile) => {
                    formData.append("station_gallery", galleryFile);
                });
            }
    ...
    return (
        <div className={styles.addStationContainer}>
            ...
            <div className={styles.addHeading}>Add Station</div>
            <div className={styles.addStationFormSection}>
                ...
                <form className={styles.formSection} onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
                    ...
                    <div className={`row`}>
                        <div className={`col-lg-6`}>
                            <label htmlFor="Cycle" className={styles.labelText}>Service Charge For</label>
                             <div className={`row`}>
                                <div className={`col-xl-10 col-lg-12`}>
                                    <CustomDropdown options={serviceForOptions} value={serviceFor} onChange={handleServiceChange} placeholder="Service Charge For"/>
                                    {errors.serviceFor && serviceFor.length === 0 && <p className={styles.error} style={{ color: 'red' }}>{errors.serviceFor}</p>}
                                </div>
                            </div>
                        </div>
                        <div className={`col-lg-6`}>
                            <label htmlFor="Cycle" className={styles.labelText}>Available For</label>
                             <div className={`row`}>
                                <div className={`col-xl-5 col-lg-6`}>
                    ...
                    <div className={`row`}>
                        <div className={`col-lg-6`}>
                            <label htmlFor="Cycle" className={styles.labelText}>Station Operator</label>
                             <div className={`row`}>
                                <div className={`col-xl-5 col-lg-6`}>
                                ...
                                <div className={`col-xl-10 col-lg-6`}>
                                    <input type="email" autoComplete="off" id="oprEmail" placeholder="Operator Email" className={styles.inputField} value={oprEmail} 
                                    onChange={(e) => setOprEmail(e.target.value)} />
                    ...
                    <div className={`row`}>
                        <div className={`col-lg-6`}>
                             <div className={`row`}>
                                <div className={`col-xl-10 col-lg-12`}>
                                    <label htmlFor="coverImage" className={styles.labelText}>Cover Image</label>
                        ...
                        <div className={`col-lg-6`}>
                            <div className={`row`}>
                                <div className={`col-xl-10 col-lg-12`}>
                                    <label htmlFor="galleryFiles" className={styles.labelText}>Gallery Image</label>
                                    <div className={styles.uploadContainer}>
...
export default AddMobilityStation;