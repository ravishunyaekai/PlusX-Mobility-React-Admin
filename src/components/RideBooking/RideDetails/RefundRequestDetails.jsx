...
const RefundRequestDetails = () => {
    ...
    const { bookingId, refund_request_id }                       = useParams();
    ...
    const obj = {
        ...
        refund_request_id : bookingId
    };
console.log("obj =>", obj);
console.log("bookingId =>", bookingId);
    const fetchComments = () => {
        setLoading(true);
        postRequestWithToken('refund-request-description-list', obj, (response) => {
...
console.log("fetchComments called");
    ...
    const handleAddComment = (text) => {
        ...
        postRequestWithToken("add-refund-comment", payload, (response) => {
    ...
    return (
        <div className='main-container'>
            ...
            <LockerModal 
                ...
                onClose   = {closeModal} 
                fields    = {statusFields} 
                id        = {`Booking ID : ${refund_request_id}`} 
                formData  = {form} 
                setForm   = {setForm} 
                isLoading = {isLoading} 
